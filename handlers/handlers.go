...
func Handlers() {
	...
	router.HandleFunc("/login", middleware.CheckDatabase(routers.Login)).Methods("POST")
	router.HandleFunc("/profile", middleware.CheckDatabase(middleware.ValidateJWT(routers.ViewProfile))).Methods("GET")
